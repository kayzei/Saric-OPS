      ...
      <div className="h-16 flex items-center px-6 border-b border-slate-800 bg-slate-900">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-slate-500 uppercase tracking-widest">{userRole === 'admin' ? 'Enterprise' : 'Staff Portal'}</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-4 border-t border-slate-800 bg-slate-900">
        <div className="text-center">
            <div className="inline-block px-2 py-1 rounded border border-kvi-gold/30 bg-kvi-gold/5">
                <p className="text-[10px] text-kvi-gold font-medium tracking-wider">SECURED BY KVI</p>
            </div>
